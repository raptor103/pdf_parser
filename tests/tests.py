...
def test_output_of_program():
    ...
    assert pdf_total_matches == {'pdf_test1.pdf': 135, 'pdf_test2.pdf': 109, 'pdf_test3.pdf': 30, 'pdf_test4.pdf': 56}
    assert pdf_matches == {'pdf_test1.pdf': {'hi': 4, 'sdeleni': 12, 'erdomed': 2, 'ranitidine': 2, 'pms': 3, 'registr': 83, 'lite': 2, 'dulezita': 6, 'programu': 21}, 'pdf_test2.pdf': {'hi': 14, 'sdeleni': 9, 'dalacin': 1, 'registr': 72, 'dulezita': 5, 'programu': 8}, 'pdf_test3.pdf': {'hi': 2, 'atomoxetin': 24, 'niekolkych': 1, 'lite': 2, 'programu': 1}, 'pdf_test4.pdf': {'lite': 3, 'registr': 1, 'ezetimib': 11, 'hi': 41}}
